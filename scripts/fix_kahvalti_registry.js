...
const report = {
    ...
    fixes: kahvaltiFixes.map(fix => ({
        food: fix.food,
        oldUrl: imageRegistry[fix.food] ? "Güncellendi" : "BULUNAMADI",
        newUrl: fix.newUrl,
...
fs.writeFileSync('./kahvalti_registry_fix_report.json', JSON.stringify(report, null, 2));
console.log(`📝 Rapor kaydedildi: kahvalti_registry_fix_report.json`);